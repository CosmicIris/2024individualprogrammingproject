...
class Clothes:
  def clothes_choice(self):
    while True:
      ...
      time.sleep(1)
      print("1) light, wool clothes with a cloak")
      time.sleep(1)
      ...
      if clothes == "1":
                  time.sleep(1)
                  print('You choose to change into light, wool clothes that are\
 comfortable and warm, as well as a cloak to shield yourself from rain.')
                  break
      elif clothes == "2":
                  time.sleep(1)
...
you bleed. Try again.')  
 ...
 clothes was a terrible mistake, as it is pouring heavily and quickly catch\
